...
<svelte:head>
	<title>Text Editor • Webtools</title>
	<meta name="Text Editor" content="Text editor from Webtools" />
</svelte:head>
	...
	>
		...
		<section
			class="{navigationPreferences.isSidemenuOpen
				...
				: ' '} mb-50 h-fit min-h-screen tablet:mr-40 mr-10 tablet:w-3/4 2xl:w-4/5"
		>
			<div
				class="min-h-screen w-[91vw] bg-primary-light p-28 outline-1 -outline-offset-12 outline-text-light/20 dark:bg-primary-dark dark:outline-text-dark/20 tablet:w-auto"
			>
				{@render children?.()}
			</div>
		</section>
