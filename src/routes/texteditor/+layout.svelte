...
<section class="relative">
	...
	>
		...
		>
			<div
				class="min-h-screen w-[91vw] bg-primary-light p-28 outline outline-1 -outline-offset-[12px] outline-text-light/20 dark:bg-primary-dark dark:outline-text-dark/20 tablet:w-auto"
			>
				{@render children?.()}
			</div>
		</section>
